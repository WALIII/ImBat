...
comp_str = 'Z:/'; % running on Rosetta...
end

counter = 1;
% 1. ZBats: /Volumes/server_home/users/tobias/flight/data_processed/ready2analyze_Zbats
Locations2Use{1} = [comp_str, 'users/tobias/flight/data_processed/ready2analyze_Zbats'];

% 2. GBats: /Volumes/server_home/users/tobias/flight/data_processed/ready2analyze_Gbats
Locations2Use{2} = [comp_str, 'users/tobias/flight/data_processed/ready2analyze_Gbats'];


% 3. /Volumes/server_home/users/tobias/flight/data_processed/topQualityData/analysis_done
Locations2Use{3} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/Gal'];
Locations2Use{4} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/Ge'];
Locations2Use{5} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/Ge_2'];
Locations2Use{6} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/Gi'];
Locations2Use{7} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/Go'];
Locations2Use{8} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/z2'];
Locations2Use{9} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/za'];
Locations2Use{10} = [comp_str, 'users/tobias/flight/data_processed/topQualityData/analysis_done/zu'];
