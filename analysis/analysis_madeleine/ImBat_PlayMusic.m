function ImBat_PlayMusic(flightPaths)
    ...
    scale2use = [1, 4, 6, 7, 8 11 13 16 18 1, 4, 6, 7, 8 11 13 16 18 1, 4, 6, 7, 8 11 13 16 18 1, 4, 6, 7, 8 11 13 16 18 ];
    ...
    for k1 = 1:length(songidx)
        ...
        %songnote = [songnote; [notecreate(songidx(k1),round(sinterval(k1)))  zeros(1,75)]'];
    ​end
