function [h,p] = ImBat_MCS_Physically_Possible_v_Actual(c_s_34,pruned_dataset,takeoff_locations_cpu,outliers,varargin)
...
% For every unique takeoff position, get how man of that takeoff position
...
%Joint_AA_vec(isnan(Joint_AA_vec))=0;
%Joint_BB_vec(isnan(Joint_BB_vec))=0;
