function [H_SIM,P_SIM] = ImBat_MCS_ThreeBack_Physically_Possible_v_Actual_simulated(S,pruned_dataset,takeoff_locations_cpu,sim_outliers);
    ...
    for x=1:1000
        ...
        % DD
        Joint_DD = zeros(size(D,1),size(D,2));
        ...
        % KS Test
        [h_sim,p_sim] = kstest2(Joint_BB_vec,Joint_DD_vec);
        H_sim(x) = h_sim;
        P_sim(x) = p_sim;
    end
    H_SIM = H_sim;
