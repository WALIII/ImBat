...
ETS_tv_offset = TS_tv - TS_tv(EoffsetB) - Eaudio_tv_offset(1) - audio_tv(offsetA); %- audio_tv(offsetB);;
Ettl_tv_offset = ttl_data_tv - ttl_data_tv(EoffsetC) - Eaudio_tv_offset(1) - audio_tv(offsetA); %- audio_tv(offsetB);

Eaudio_tv_offset = audio_tv - audio_tv(EoffsetA) - Eaudio_tv_offset(1) - audio_tv(offsetA);
...
out.Location_time = ETS_tv_offset'; % WAS ORIGINALLY TS_tv_offset. MCS
...
out.Microphone_Time = Ettl_tv_offset'; % WAS ORIGINALLY ttl_tv_offset. MCS
...
metrics.Eaudio_tv_offset = Eaudio_tv_offset;
metrics.ETS_tv_offset = ETS_tv_offset;
metrics.Ettl_tv_offset = Ettl_tv_offset;
