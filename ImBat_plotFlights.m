...
mx([nonflying; toofast]) = nan;%mx(nonflying) = nan; %mx([nonflying; toofast]) = nan;
my([nonflying; toofast]) = nan;%my(nonflying) = nan;%my([nonflying; toofast]) = nan;
mz([nonflying; toofast]) = nan;%mz(nonflying) = nan;%mz([nonflying; toofast]) = nan;
