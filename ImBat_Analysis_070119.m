...
a(1) = subplot(2,1,1);
hold on
plot(ROI_Data{1,day}.Alignment.out.Location_time,ROI_Data{1,day}.Alignment.out.flights)
plot(ROI_Data{1,day}.Alignment.out.video_times,zscore(mean(ROI_Data{1,day}.ROIs.results.C(:,:),1))*1000);
a(2) = subplot(2,1,2);
hold on;
