        ...
        for ii = 1:size(k1,1)
            if k1(ii)<5
                ...
                if typ == 'med'
                    ...
                    video(:,:,k1(ii)) = (mean(video(:,:,k1(ii)+2:k1(ii)+5),3));
                end
            ...
            elseif k1(ii)>size(k1,1)-5
                ...
                if typ == 'med'  
                    ...
                    video(:,:,k1(ii)) = (mean(video(:,:,k1(ii)-4:k1(ii)-2),3));
                end
                ...
                if typ == 'med'
                    ...
                    video(:,:,k1(ii)) = (mean(video(:,:,k1(ii)-4:k1(ii)-2),3)+mean(video(:,:,k1(ii)+2:k1(ii)+5),3))/2;
                end
            end
        end
    end
