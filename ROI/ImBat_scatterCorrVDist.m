ROI_refined = ROI_refined_Gal_11to20_c65;
...
if saveFlag == 1
    ...
    savefig(scatterCorrDist,[saveDir 'scatterCorrDist_' ROI_refined.batName{1} '_11to20_' datestr(now,'yymmdd-hhMMss') '.fig']);
    saveas(scatterCorrDist, [saveDir 'scatterCorrDist_' ROI_refined.batName{1} '_11to20_' datestr(now,'yymmdd-hhMMss') '.tif']);
