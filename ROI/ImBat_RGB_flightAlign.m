function ImBat_RGB_flightAlign(day1,day2,day3)
batId = 'Gal';
clustNum = 2;
saveFlag = 0;
saveTag = 'day1_clust2Vfull';
...
if isempty(day3)
    if day1==day2
        ...
        plotTitle = [batId ' clust ' num2str(clustNum) ': Day ' num2str(day1) '(r) v full session (g)'];
    else
        IM1 = mat2gray(activity_allTrials.maxMeanFrames_dur{clustNum}{day1});
        IM2 = mat2gray(activity_allTrials.maxMeanFrames_dur{clustNum}{day2});
        plotTitle = [batId ' clust ' num2str(clustNum) ': Day ' num2str(day1) '(r) v Day ' num2str(day2) '(g)']
    end
    IM3 = [];
     % Alignment script
